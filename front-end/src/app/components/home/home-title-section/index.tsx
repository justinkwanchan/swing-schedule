...
export default function HomeTitleSection({ events }: Props) {
  return (
    <section className="flex flex-col md:flex-row w-full mb-12">
      <div className="bg-light-grey relative md:h-auto md:w-2/5 2xl:w-1/3">
        ...
        />
        <p className="my-4 mx-14 text-dark-grey tracking-widest md:mt-[42vw] xl:mt-[40vw] xl:text-lg 2xl:mt-[34vw]">
